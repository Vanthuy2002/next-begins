...
const Button = (props: ButtonProps) => {
  ...
  return (
    <button
      className={`focus:ring-4 focus:outline-none focus:ring-blue-300 px-5 py-2.5 font-medium rounded-lg text-center ${className} ${variantClasses[variant]} ${sizeClasses[size]}`}
      {...props}
    >
      {children}
    </button>
